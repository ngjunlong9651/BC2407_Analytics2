...
setwd('/Users/jinjeetong/BC2407/BC2407 Course Materials/S3 Association Rules')
...
#export long format  as csv file.
...
trans2 <- as(longdata2, "transactions")  # Convert to transactions datatype
